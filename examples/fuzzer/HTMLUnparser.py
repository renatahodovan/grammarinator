# Generated by Grammarinator 19.3+11.g5f0983b.d20191229

from itertools import chain
from grammarinator.model import *
...
class HTMLUnparser(Grammarinator):
    ...
    def __init__(self, unlexer):
        ...
        self.unlexer.any_char = self.any_unicode_char
    ...
    def htmlDocument(self):
        ...
        if self.unlexer.max_depth >= 1:
            for _ in self.unlexer.model.zero_or_more():
                choice = self.unlexer.model.choice([0 if [2, 1][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_119', i), 1) for i, w in enumerate([1, 1])])
        ...
        if self.unlexer.max_depth >= 2:
            for _ in self.unlexer.model.zero_or_one():
                current += self.xml()

        if self.unlexer.max_depth >= 1:
            for _ in self.unlexer.model.zero_or_more():
                choice = self.unlexer.model.choice([0 if [2, 1][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_124', i), 1) for i, w in enumerate([1, 1])])
        ...
        if self.unlexer.max_depth >= 1:
            for _ in self.unlexer.model.zero_or_more():
                choice = self.unlexer.model.choice([0 if [2, 1][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_129', i), 1) for i, w in enumerate([1, 1])])
    ...
    def htmlElement(self):
        ...
        choice = self.unlexer.model.choice([0 if [3, 3, 3, 2, 2, 2][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_135', i), 1) for i, w in enumerate([1, 1, 1, 1, 1, 1])])
    ...
    def htmlContent(self):
        ...
        if self.unlexer.max_depth >= 2:
            for _ in self.unlexer.model.zero_or_more():
                choice = self.unlexer.model.choice([0 if [3, 2, 2][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_151', i), 1) for i, w in enumerate([1, 1, 1])])
    ...
    def htmlAttribute(self):
        ...
        choice = self.unlexer.model.choice([0 if [4, 3][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_156', i), 1) for i, w in enumerate([1, 1])])
    ...
    def htmlChardata(self):
        ...
        choice = self.unlexer.model.choice([0 if [1, 1][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_159', i), 1) for i, w in enumerate([1, 1])])
    ...
    def htmlMisc(self):
        ...
        choice = self.unlexer.model.choice([0 if [2, 1][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_162', i), 1) for i, w in enumerate([1, 1])])
    ...
    def htmlComment(self):
        ...
        choice = self.unlexer.model.choice([0 if [1, 1][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_165', i), 1) for i, w in enumerate([1, 1])])
    ...
    def script(self):
        ...
        choice = self.unlexer.model.choice([0 if [1, 1][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_168', i), 1) for i, w in enumerate([1, 1])])
    ...
    def style(self):
        ...
        choice = self.unlexer.model.choice([0 if [1, 1][i] > self.unlexer.max_depth else w * self.unlexer.weights.get(('alt_171', i), 1) for i, w in enumerate([1, 1])])

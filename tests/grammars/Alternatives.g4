...
// TEST-GENERATE: -p {grammar}Unparser -l {grammar}Unlexer -r start -j 1 -n 5 -o {tmpdir}/{grammar}S%d.txt -c 0.9
// TEST-GENERATE: -p {grammar}Unparser -l {grammar}Unlexer -r start -j 2 -n 5 -o {tmpdir}/{grammar}M%d.txt -c 0.9
